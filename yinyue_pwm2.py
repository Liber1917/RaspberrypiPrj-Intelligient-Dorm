...
# 音调 0表示休止符
songP = [
    CM[1],CM[2],CM[3],CM[1],CM[0],CM[1],CM[2],CM[3],CM[1],CM[0],
    CM[3],CM[4],CM[5],CM[0],CM[3],CM[4],CM[5],CM[0],
    CM[5],CM[6],CM[5],CM[4],CM[3],CM[1],CM[0],CM[5],CM[6],CM[5],CM[4],CM[3],CM[1],CM[0],
    CM[1],CH[5],CM[1],CM[0], CM[1],CH[5],CM[1],CM[0],
# 音调对应的节拍
songT = [
...
stopButton = Tkinter.Button(top, text="关闭",command=top.quit)
